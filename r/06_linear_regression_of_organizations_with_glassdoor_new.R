...
allContributions <- read.csv(paste0("data/csv/calculated/contributions_ratio.csv"), header = T, stringsAsFactors = F)
...
# glassdoor$organization_name <- glassdoor$login
...
# glassdoor$number_of_top_repos <- glassdoor$number_of_distinct_repos
...
write(content, file = "tables/glassdoor_firm_rating.tex")
